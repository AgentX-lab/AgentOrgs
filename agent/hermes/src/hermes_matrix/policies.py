"""Pure Matrix policy helpers for the AgentOrgs Hermes overlay.

No Matrix SDK imports. Models outbound mention enrichment, dual allow-lists,
and group-room history buffering.
"""
...
@dataclass
class HistoryBuffer:
    """Per-room history buffer for unmentioned group chatter."""
